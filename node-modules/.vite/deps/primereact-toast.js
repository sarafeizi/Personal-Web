...
var ToastMessage = React9.memo(React9.forwardRef(function(props, ref) {
  ...
  var _React$useState = React9.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focused = _React$useState2[0], setFocused = _React$useState2[1];
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    var icon = _closeIcon || React9.createElement(TimesIcon, buttonIconProps);
    ...
    if (closable !== false) {
      return React9.createElement("div", null, React9.createElement("button", closeButtonProps, closeIcon2, React9.createElement(Ripple, null)));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (messageInfo) {
      ...
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = React9.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = React9.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = React9.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = React9.createElement(CheckIcon, iconProps);
            break;
        }
      }
      ...
      return contentEl || React9.createElement(React9.Fragment, null, messageIcon, React9.createElement("div", textProps, React9.createElement("span", summaryProps, summary), detail && React9.createElement("div", detailProps, detail)));
    }
    return null;
  };
  ...
  return React9.createElement("div", messageProps, React9.createElement("div", contentProps, message2, closeIcon));
}));
ToastMessage.displayName = "ToastMessage";
var messageIdx = 0;
var Toast = React9.memo(React9.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React9.useContext(PrimeReactContext);
  var props = ToastBase.getProps(inProps, context);
  var _React$useState = React9.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  var createElement4 = function createElement5() {
    ...
    return React9.createElement("div", rootProps, React9.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(messageInfo, index) {
      var messageRef = React9.createRef();
      return React9.createElement(CSSTransition2, _extends3({
        ...
        message: messageInfo.message
      }) : React9.createElement(ToastMessage, {
        hostName: "Toast",
        ref: messageRef,
        messageInfo,
        index,
